/**
 * @file: tests/next/example/gallary/render/photon_mapping
 * @author: sailing-innocent
 * @date: 2023-09-09
 * @brief: the basic photon-mapping example
*/
...
LUISA_STRUCT(luisa::test::Photon, position, power, in_direction, nxt) {};
LUISA_STRUCT(luisa::test::HeapNode, dis, index) {};

namespace luisa::test {

int photon_mapping(Device &device) {
    log_level_info();
