...
[[nodiscard]] inline V read_pixel(LCPixelStorage storage, const uint8_t *p) noexcept {
    switch (storage) {
        case LC_PIXEL_STORAGE_BYTE1:
            return detail::read_pixel<V, T, uint8_t, 1u>(p);
        case LC_PIXEL_STORAGE_BYTE2:
            return detail::read_pixel<V, T, uint8_t, 2u>(p);
        case LC_PIXEL_STORAGE_BYTE4:
            return detail::read_pixel<V, T, uint8_t, 4u>(p);
        case LC_PIXEL_STORAGE_SHORT1:
            return detail::read_pixel<V, T, uint16_t, 1u>(p);
        case LC_PIXEL_STORAGE_SHORT2:
            return detail::read_pixel<V, T, uint16_t, 2u>(p);
        case LC_PIXEL_STORAGE_SHORT4:
            return detail::read_pixel<V, T, uint16_t, 4u>(p);
        case LC_PIXEL_STORAGE_INT1:
            return detail::read_pixel<V, T, uint32_t, 1u>(p);
        case LC_PIXEL_STORAGE_INT2:
            return detail::read_pixel<V, T, uint32_t, 2u>(p);
        case LC_PIXEL_STORAGE_INT4:
            return detail::read_pixel<V, T, uint32_t, 4u>(p);
        case LC_PIXEL_STORAGE_HALF1:
            return detail::read_pixel<V, T, float16_t, 1u>(p);
        case LC_PIXEL_STORAGE_HALF2:
            return detail::read_pixel<V, T, float16_t, 2u>(p);
        case LC_PIXEL_STORAGE_HALF4:
            return detail::read_pixel<V, T, float16_t, 4u>(p);
        case LC_PIXEL_STORAGE_FLOAT1:
            return detail::read_pixel<V, T, float, 1u>(p);
        case LC_PIXEL_STORAGE_FLOAT2:
            return detail::read_pixel<V, T, float, 2u>(p);
        case LC_PIXEL_STORAGE_FLOAT4:
            return detail::read_pixel<V, T, float, 4u>(p);
        default:
            break;
    }
    return {};
...
inline void write_pixel(LCPixelStorage storage, uint8_t *p, V v) noexcept {
    switch (storage) {
        case LC_PIXEL_STORAGE_BYTE1:
            detail::write_pixel<V, T, uint8_t, 1u>(p, v);
            break;
        case LC_PIXEL_STORAGE_BYTE2:
            detail::write_pixel<V, T, uint8_t, 2u>(p, v);
            break;
        case LC_PIXEL_STORAGE_BYTE4:
            detail::write_pixel<V, T, uint8_t, 4u>(p, v);
            break;
        case LC_PIXEL_STORAGE_SHORT1:
            detail::write_pixel<V, T, uint16_t, 1u>(p, v);
            break;
        case LC_PIXEL_STORAGE_SHORT2:
            detail::write_pixel<V, T, uint16_t, 2u>(p, v);
            break;
        case LC_PIXEL_STORAGE_SHORT4:
            detail::write_pixel<V, T, uint16_t, 4u>(p, v);
            break;
        case LC_PIXEL_STORAGE_INT1:
            detail::write_pixel<V, T, uint32_t, 1u>(p, v);
            break;
        case LC_PIXEL_STORAGE_INT2:
            detail::write_pixel<V, T, uint32_t, 2u>(p, v);
            break;
        case LC_PIXEL_STORAGE_INT4:
            detail::write_pixel<V, T, uint32_t, 4u>(p, v);
            break;
        case LC_PIXEL_STORAGE_HALF1:
            detail::write_pixel<V, T, float16_t, 1u>(p, v);
            break;
        case LC_PIXEL_STORAGE_HALF2:
            detail::write_pixel<V, T, float16_t, 2u>(p, v);
            break;
        case LC_PIXEL_STORAGE_HALF4:
            detail::write_pixel<V, T, float16_t, 4u>(p, v);
            break;
        case LC_PIXEL_STORAGE_FLOAT1:
            detail::write_pixel<V, T, float, 1u>(p, v);
            break;
        case LC_PIXEL_STORAGE_FLOAT2:
            detail::write_pixel<V, T, float, 2u>(p, v);
            break;
        case LC_PIXEL_STORAGE_FLOAT4:
            detail::write_pixel<V, T, float, 4u>(p, v);
            break;
        default:
            break;
    }
...
static constexpr const float ewa_filter_weight_lut[] = {
    0.8646647330f, 0.8490400310f, 0.8336595300f, 0.8185192940f, 0.8036156300f, 0.78894478100f, 0.7745032310f,
    0.7602872850f,
    0.7462934850f, 0.7325183150f, 0.7189583780f, 0.7056102750f, 0.6924707890f, 0.67953658100f, 0.6668044920f,
    0.6542713050f,
    0.6419339780f, 0.6297893520f, 0.6178345080f, 0.6060665250f, 0.5944823620f, 0.58307915900f, 0.5718541740f,
    0.5608045460f,
    0.5499275920f, 0.5392205720f, 0.5286808610f, 0.5183058380f, 0.5080928800f, 0.49803954400f, 0.4881432650f,
    0.4784016010f,
    0.4688121680f, 0.4593725800f, 0.4500804540f, 0.4409335260f, 0.4319294690f, 0.42306613900f, 0.4143413310f,
    0.4057527780f,
    0.3972984550f, 0.3889762160f, 0.3807840350f, 0.3727198840f, 0.3647816180f, 0.35696744900f, 0.3492754100f,
    0.3417034750f,
    0.3342499140f, 0.3269128200f, 0.3196903470f, 0.3125807050f, 0.3055821660f, 0.29869294200f, 0.2919114230f,
    0.2852358220f,
    0.2786645290f, 0.2721959350f, 0.2658283710f, 0.2595603470f, 0.2533901930f, 0.24731649500f, 0.2413376720f,
    0.2354522790f,
    0.2296588570f, 0.2239559440f, 0.2183421400f, 0.2128160450f, 0.2073762860f, 0.20202152400f, 0.1967504470f,
    0.1915617140f,
    0.1864540130f, 0.1814261530f, 0.1764768510f, 0.1716048870f, 0.1668090670f, 0.16208814100f, 0.1574410050f,
    0.1528664680f,
    0.1483634260f, 0.1439307180f, 0.1395672710f, 0.1352720110f, 0.1310438660f, 0.12688179300f, 0.1227847190f,
    0.1187516900f,
    0.1147816330f, 0.1108736400f, 0.1070266960f, 0.1032398790f, 0.0995122194f, 0.09584279360f, 0.0922307223f,
    0.0886750817f,
    0.0851749927f, 0.0817295909f, 0.0783380121f, 0.0749994367f, 0.0717130303f, 0.06847797330f, 0.0652934611f,
    0.0621587038f,
    0.0590728968f, 0.0560353249f, 0.0530452281f, 0.0501018465f, 0.0472044498f, 0.04435232280f, 0.0415447652f,
    0.0387810767f,
    0.0360605568f, 0.0333825648f, 0.0307464004f, 0.0281514227f, 0.0255970061f, 0.02308247980f, 0.0206072628f,
    0.0181707144f,
    0.0157722086f, 0.0134112090f, 0.0110870898f, 0.0087992847f, 0.0065472275f, 0.00433036685f, 0.0021481365f,
    0.0000000000f};
...
[[nodiscard]] inline auto texture_coord_point(LCSamplerAddress address, T uv, T s) noexcept {
    switch (address) {
        case LC_SAMPLER_ADDRESS_EDGE:
            return lc_clamp(uv, T(0.0f), T(one_minus_epsilon)) * s;
        case LC_SAMPLER_ADDRESS_REPEAT:
            return lc_fract(uv) * s;
        ...
        case LC_SAMPLER_ADDRESS_ZERO:
            return lc_select(uv * s, T{65536.f}, uv < 0.f || uv >= 1.f);
    }
    return T{65536.f};
}
...
[[nodiscard]] inline lc_float4
texture_sample_linear(TextureView view, LCSamplerAddress address, lc_float2 uv) noexcept {
...
[[nodiscard]] inline lc_float4
texture_sample_linear(TextureView view, LCSamplerAddress address, lc_float3 uvw) noexcept {
...
[[nodiscard]] inline lc_float4
texture_sample_point(TextureView view, LCSamplerAddress address, lc_float3 uvw) noexcept {
    auto size = lc_make_float3(view.size3d());
...
[[nodiscard]] inline lc_uint2 lc_texture2d_size(const KernelFnArgs *k_args, const Texture2D &tex) noexcept {
    return lc_uint2(tex._0.width, tex._0.height);
}

[[nodiscard]] inline lc_uint3 lc_texture3d_size(const KernelFnArgs *k_args, const Texture3D &tex) noexcept {
    return lc_uint3(tex._0.width, tex._0.height, tex._0.depth);
}
...
template<class V>
inline void lc_texture2d_write(const KernelFnArgs *k_args, const Texture2D &tex, lc_uint2 uv, V value) noexcept {
    using T = element_type<V>;
    lc_texture_view(&tex._0, tex._1).write2d<V, T>(uv, value);
}

template<class V>
inline void lc_texture3d_write(const KernelFnArgs *k_args, const Texture3D &tex, lc_uint3 uv, V value) noexcept {
    using T = element_type<V>;
    lc_texture_view(&tex._0, tex._1).write3d<V, T>(uv, value);
}

[[nodiscard]] inline lc_float4 lc_texture_2d_sample(const KernelFnArgs *k_args,
...
[[nodiscard]] inline lc_float4 lc_bindless_texture2d_sample(const KernelFnArgs *k_args,
    ...
    return lc_texture_2d_sample(k_args, &tex, sampler, uv);
}

[[nodiscard]] inline lc_float4 lc_texture_3d_sample(const KernelFnArgs *k_args,
...
[[nodiscard]] inline lc_float4 lc_bindless_texture3d_sample(const KernelFnArgs *k_args,
                                                            const BindlessArray &array, size_t index,
                                                            lc_float3 uv) noexcept {
    auto &&tex = lc_bindless_texture_3d(k_args, array, index);
    auto sampler = LCSampler::decode(tex.sampler);
    return lc_texture_3d_sample(k_args, &tex, sampler, uv);
}

[[nodiscard]] inline lc_float4 lc_texture2d_sample_level(const KernelFnArgs *k_args,
                                                          const Texture *tex, LCSampler sampler, lc_float2 uv,
                                                          lc_float lod) noexcept {
...
[[nodiscard]] inline lc_float4 lc_bindless_texture2d_sample_level(const KernelFnArgs *k_args,
                                                                   const BindlessArray &array, size_t index,
                                                                   lc_float2 uv, lc_float lod) noexcept {
    auto &&tex = lc_bindless_texture_2d(k_args, array, index);
    auto sampler = LCSampler::decode(tex.sampler);
    return lc_texture2d_sample_level(k_args, &tex, sampler, uv, lod);
}

[[nodiscard]] inline lc_float4 lc_texture3d_sample_level(const KernelFnArgs *k_args,
                                                          const Texture *tex, LCSampler sampler, lc_float3 uvw,
                                                          lc_float lod) noexcept {
    auto filter = sampler.filter;
    if (lod <= 0.0f || tex->mip_levels == 0 || filter == LC_SAMPLER_FILTER_POINT) {
        return lc_texture_3d_sample(k_args, tex, sampler, uvw);
    }
    auto level0 = lc_min(static_cast<lc_uint>(lod), tex->mip_levels - 1u);
...
[[nodiscard]] inline lc_float4 lc_bindless_texture3d_sample_level(const KernelFnArgs *k_args,
                                                                   const BindlessArray &array, size_t index,
                                                                   lc_float3 uvw, lc_float lod) noexcept {
    auto &&tex = lc_bindless_texture_3d(k_args, array, index);
    auto sampler = LCSampler::decode(tex.sampler);
    return lc_texture3d_sample_level(k_args, &tex, sampler, uvw, lod);
}

[[nodiscard]] inline lc_float4 lc_texture2d_sample_grad(const KernelFnArgs *k_args,
                                                         const Texture *tex, LCSampler sampler, lc_float2 uv,
    ...
    if (sampler.filter != LC_SAMPLER_FILTER_ANISOTROPIC) {
        ...
        return lc_texture2d_sample_level(k_args, tex, sampler, uv, level);
    }
...
[[nodiscard]] inline lc_float4 lc_bindless_texture2d_sample_grad(const KernelFnArgs *k_args,
                                                                 const BindlessArray &array, size_t index, lc_float2 uv,
                                                                 lc_float2 dpdx, lc_float2 dpdy) noexcept {
    auto &&tex = lc_bindless_texture_2d(k_args, array, index);
    auto sampler = LCSampler::decode(tex.sampler);
    return lc_texture2d_sample_grad(k_args, &tex, sampler, uv, dpdx, dpdy);
}

[[nodiscard]] inline lc_float4 lc_texture3d_sample_grad(const KernelFnArgs *k_args,
                                                         const Texture *tex, LCSampler sampler, lc_float3 uvw,
                                                         lc_float3 dpdx, lc_float3 dpdy) noexcept {
    ...
    if (sampler.filter != LC_SAMPLER_FILTER_ANISOTROPIC) {
        ...
        auto level = 0.5f * log2f(lc_max(ll(dpdx * s), ll(dpdy * s)));
        return lc_texture3d_sample_level(k_args, tex, sampler, uvw, level);
    }
    auto len_dpdx = lc_length(dpdx);
    auto len_dpdy = lc_length(dpdy);
    auto longer = lc_max(len_dpdx, len_dpdy);
...
[[nodiscard]] inline lc_float4 lc_bindless_texture3d_sample_grad(const KernelFnArgs *k_args,
                                                                  const BindlessArray &array, size_t index,
                                                                  lc_float3 uvw, lc_float3 dpdx,
                                                                  lc_float3 dpdy) noexcept {
    auto &&tex = lc_bindless_texture_3d(k_args, array, index);
    auto sampler = LCSampler::decode(tex.sampler);
    return lc_texture3d_sample_grad(k_args, &tex, sampler, uvw, dpdx, dpdy);
}
